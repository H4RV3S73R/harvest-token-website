...
export const Home = () => (
    <>
        ...
        <section class="section">
            ...
            <div class="columns is-unselectable has-text-justified is-multiline">
                ...
                <div class="column has-text-centered"
                    ...
                    <div class="has-text-centered">
                        <p class="tag is-size-3-desktop is-size-5-mobile is-info tag is-rounded has-text-centered">General Information</p>
                        <p>&nbsp;</p>
                    </div>
                    <p>Token Name: <strong>HARVEST</strong></p>
                    <p>Abbreviation: <strong>HST</strong></p>
                    <p>Max Total Supply: <strong>10 Million $HST</strong></p>
        ...
        <section class="section">
            ...
            <div class="columns is-vcentered is-unselectable has-text-justified"
                style={{

    ...
    <>
        ...
        <div class="columns">
            ...
            <div class="column">
                ...
                <p><strong>Mintable</strong>: Privileged accounts are <strong>NOT</strong> able to create more supply.</p>
                <p><strong>Burnable</strong>: Token holders are able to destroy their tokens.</p>
                <p><strong>Pausable</strong>: Privileged accounts can <strong>NOT</strong> pause the functionality.</p>
                <p><strong>Permit</strong>: Without paying gas, token holders are <strong>NOT</strong> able to allow third parties to transfer from their account.</p>
                <p><strong>Votes</strong>: Keeps track of historical balances for voting in on-chain governance, with a way to delegate one's voting power to a trusted account.</p>
